...
const HeroSection = () => {
  return (
    <Box className="!w-screen !bg-gradient-to-b from-lime-50 to-white min-h-[80vh] !flex !py-20">
      <Box className="!mx-auto !my-auto !max-w-3xl !px-16 !flex !flex-col !gap-6">
        ...
        <Box className="flex flex-wrap !gap-2 md:gap-4! !mx-auto !mt-4">
          ...
          <Button className="!rounded-4xl !bg-white !border-lime-600 !border-1 !text-lime-600 !font-semibold !text-xl !px-8 !py-4 !mx-auto !w-full md:w-auto! !normal-case">
            Explore Services
          </Button>
        </Box>
      </Box>
